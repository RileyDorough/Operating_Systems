...
.filename_provided:
	...
	je .cont_exit		; Continue to exit from hex program

	mov dx, 0			; position variable

.loop_begin:			; Enter loop and check for EOF
	cmp bx, 0
	je .cont_exit
...
; =====================================================================
	...
	help_text		db 'Commands: DIR, LS, COPY, REN, DEL, CAT, SIZE, CLS, HELP, TIME, DATE, VER, EXIT, HEX', 13, 10, 0
